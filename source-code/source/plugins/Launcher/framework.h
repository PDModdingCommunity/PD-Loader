...
ConfigOptionBase* optionsArray[] = {
	...
	new BooleanOption(L"replace_mdata_ram_dir", LAUNCHER_SECTION, CONFIG_FILE, L"Replace mdata and ram directories", L"Sets the mdata directory to mdata/ and the ram directory to the game directory.\nDo not turn it off unless you're using the SegaTools.", true, false),
};
